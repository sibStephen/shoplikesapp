...
function showTimeline(respJson) {
	...
	if (recommendations) {
		...
		for (var i = 0; i < recommendations.length; i++) {
			...
			var store_image = "ebay_icon.png"
			if (product['store'] == "flipkart") {
				store_image = "flipkart_icon.png";
			}
...
function showModal(response) {
	...
	category_name.innerHTML = response["product"]["product_category"];
	...
	product_price.innerHTML = response["product"]["product_price"];
